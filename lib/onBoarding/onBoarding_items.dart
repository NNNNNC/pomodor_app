...
class onBoardingItems{
  List<onBoardingInfo> items = [
    onBoardingInfo(
      title: 'Discover the joy of learning with Study Assistant: your guide to academic adventure!',
    ...
    onBoardingInfo(
      title: 'Manage your task and notes',
      image: 'assets/images/topic.png'
      ),
    onBoardingInfo(
      title: 'Customized your learning environment',
