...
class pomodoroManualDisplay extends StatefulWidget {
  ...
  @override
  State<pomodoroManualDisplay> createState() => _pomodoroManualDisplayState();
}

class _pomodoroManualDisplayState extends State<pomodoroManualDisplay> {
  final controller = pomodoroManualItems();
