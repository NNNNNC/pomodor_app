          ...
          child: ListView(
            ...
            children: [
              ...
              buildOption(
                ...
                false,
                true,
                enabled: settingsBox.get('enableReminder', defaultValue: false),
              ),
              buildSectionHeader(context, "POMODORO"),
              buildToggleOption(
                  context, "Enable Skipping Breaks", 'enableSkip', true, false),
              buildToggleOption(context, "Disable Long Breaks",
                  'disableLongBreak', false, false),
              buildToggleOption(
                  context, "Disable White Noise", 'disableNoise', false, true),
              buildSectionHeader(context, "OTHERS"),
              buildPermission(
                  context, "Configure App Permissions", true, false),
              buildOption(context, "Help/Feedback", buildHelpFeedback(), false,
                  false, true, false, false, false),
              buildOption(context, "App Info", buildAppInfo(), false, false,
                  false, false, false, false),
              buildOption(context, "Version", buildVersionInfo(), false, true,
